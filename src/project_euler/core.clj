...
; solved by hand in excel
; for 2nd row calculated sums s1 = 75+95 = 170, s2 = 75+64=139
; for next row calculated  o1=s1=170,o2=max(s1,s2)=170,o3 = s2=139
; and for 3rd row r1=17, r2=47, r3=82
; calculated p1=o1+r1=170+17=187, p2=o2+r2=170+47=217, p3=o3+r3=139+82=221
; so, for 3row triangle, maximum sum is 221
; expanding this algorithm to full triangle result is 1074
